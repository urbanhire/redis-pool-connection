...
test(file + "Kill a Redis Connection", function(t) {
  var redisClient = require('../index.js')(options); // connect
...
test(file + " Connect to LOCAL Redis instance Which was CLOSED in Previous Test", function(t) {
  ...
  redisClient = require('../index.js')(options); // re-connect
  redisSub = require('../index.js')(options, 'SUBSCRIBER');
  t.equal(redisClient.address, '127.0.0.1:6379', "✓ Redis Client RE-connected to: " + redisClient.address)
